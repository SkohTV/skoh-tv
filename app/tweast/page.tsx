...
export default function Page() {
  return (
    <div>
      ...
      <Card logo={Youtube} url='https://www.youtube.com/@Tweastt' name='Youtube' padded={true} colors={{ bg: 'bg-red-600/20', hover_bg: 'hover:bg-red-600/50', border: 'border-red-600' }} />
