...
export default function Page() {
  return (
    <div>
      ...
      <Card logo={Twitch} url='https://twitch.tv/NotSkoh' name='Twitch' padded={true} colors={{ bg: 'bg-purple-800/20', hover_bg: 'hover:bg-purple-800/50', border: 'border-purple-800' }} />
